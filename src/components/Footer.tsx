    ...
    <footer className="bg-secondary/50 backdrop-blur-sm border-t border-border/50">
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <h3 className="text-lg font-bold mb-4 text-gradient">Youssef Ahmed</h3>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-4">
              <input
                ...
                className="w-full rounded-lg border border-border bg-background/50 backdrop-blur-sm px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                required
              />
